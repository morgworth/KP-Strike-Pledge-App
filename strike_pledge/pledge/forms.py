...
class ValidateForm(forms.Form):
    ...
    tweet = forms.CharField(max_length=235, required=False, initial='', label='', widget=forms.Textarea(attrs={'placeholder':'Your comment will tweeted (anonymously)'}))
    personal_email=forms.EmailField(required=False, label='', initial='', widget=forms.TextInput(attrs={'placeholder':'janedoe@email.com'}))
